...
to ageing
  ...
  ;; ask n-of 10 turtles with [age = 1][die]
end

to work_and_get_paid
  ask turtles with [age = 1 or age = 2][
    set wage wage + 1
  ]
end
...
to reproduction
  ask turtles with [age = 1][
    ...
    hatch (randomInt reproduction_rate) [
      set age 0
      set wage 0
    ]
  ]
...
"a0" 1.0 0 -10899396 true "" "plot count turtles with [age = 0]"
"a1" 1.0 0 -13840069 true "" "plot count turtles with [age = 1]"
"a2" 1.0 0 -14835848 true "" "plot count turtles with [age = 2]"
...
"" ""
PENS
"t_wage" 1.0 0 -16777216 true "" "plot sum [wage] of turtles"
...
## v0.02
### TODO:
1. death rate (by real data or math model?)
